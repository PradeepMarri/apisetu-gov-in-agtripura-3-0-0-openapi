# Accountants General, Tripura MCP Server

This MCP (Model Content Protocol) server provides access to Accountants General, Tripura API functionality through HTTP, HTTPS, and STDIO transport modes.
